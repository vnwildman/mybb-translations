...
$l['post_spam_success'] = "Chủ đề đã được xác nhận là spam thành công.";
$l['thread_spam_success'] = "Chủ đề đã được xác nhận là spam thành công.";
...
$l['redirect_return_thread']= "Để chuyển về chủ đề bạn có thể click <a href=\"{1}\">ở đây</a>.<br />hoặc có thể trở về <a href=\"{2}\">diễn đàn.</a>";
