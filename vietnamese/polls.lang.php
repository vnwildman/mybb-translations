...
$l['nav_postpoll'] = "Gửi bình chọn";
$l['nav_editpoll'] = "Sửa bình chọn";
$l['nav_pollresults'] = "Kết quả bình chọn";
...
$l['poll_options_note'] = "Tùy chọn bình bầu nên ngắn gọn và đúng chủ điểm.";
$l['options'] = "Tùy chọn:";
...
$l['update_poll'] = "Cập nhật bình chọn";
$l['option'] = "Tùy chọn";
$l['votes'] = "Lượt:";
...
$l['error_pollalready'] = "Chủ đề đã bình chọn rồi!";
...
$l['poll_deleted'] = "Bình chọn đã xóa";
$l['poll_edited'] = "Bình chọn đã sửa";
?>