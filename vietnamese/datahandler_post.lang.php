...
$l['postdata_subject_too_long'] = 'Tiêu đề quá dài. Xin hãy nhập nội dung của nó ngắn hơn 85 ký tự(hiện giờ là {1}).';
...
$l['postdata_too_many_images'] = 'Bài viết của bạn gồm có {1} hình ảnh, trong khi đó diễn đàn chỉ cho phép {2} hình ảnh trên một bài viết. Bạn hãy giảm số lượng ảnh cho phù hợp.';

$l['thread_closed'] = "Chủ đề bị khoá";
$l['thread_opened'] = "Chủ đề đã mở";
$l['thread_stuck'] = "Chủ đề đã được dán";
$l['thread_unstuck'] = "Chủ đề đã được bỏ dán";
