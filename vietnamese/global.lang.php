...
$l['welcome_usercp'] = "BĐK người dùng";
$l['welcome_modcp'] = "BĐK điều phối";
$l['welcome_admin'] = "BĐK quản trị";
$l['welcome_logout'] = "Thoát";
$l['welcome_login'] = "Đăng nhập";
$l['welcome_register'] = "Đăng kí";
$l['welcome_open_buddy_list'] = "Danh sách bạn bè";
$l['welcome_newposts'] = "Bài mới";
$l['welcome_todaysposts'] = "Bài hôm nay";
$l['welcome_pms'] = "Tin nhắn";
$l['welcome_pms_usage'] = "(Chưa đọc {1}, Tổng cộng {2})";
$l['welcome_back'] = "<strong>Xin chào mừng, {1}</strong>. Lần ghé trước: {2}";
$l['welcome_guest'] = "Xin chào quý khách!";
$l['welcome_current_time'] = "<strong>Bây giờ là:</strong> {1}";

$l['moved_prefix'] = "Đã chuyển đi:";
$l['sticky_prefix'] = "<strong>Nổi bật:</strong>";
$l['poll_prefix'] = "Bình chọn:";
$l['announcement_prefix'] = "<strong>Thông báo:</strong>";

$l['forumbit_announcements'] = "Thông báo";
$l['forumbit_stickies'] = "Bài viết quan trọng";
$l['forumbit_forum'] = "Diễn đàn";
$l['forumbit_threads'] = "Chủ đề";
$l['forumbit_posts'] = "Bài viết";
$l['forumbit_lastpost'] = "Bài viết cuối";
$l['forumbit_moderated_by'] = "Quản lý bởi:";
...
$l['today'] = "Hôm nay";
$l['yesterday'] = "Hôm qua";
$l['error'] = "Tin nhắn của diễn đàn";

$l['multipage_pages'] = "Trang ({1}):";
$l['multipage_last'] = "Cuối";
$l['multipage_first'] = "Đầu";
$l['multipage_next'] = "Tiếp";
$l['multipage_previous'] = "Trước";
$l['multipage_link_start'] = " ...";
$l['multipage_link_end'] = "... ";

$l['editor_title_bold'] = "Chèn chữ in đậm";
$l['editor_title_italic'] = "Chèn chữ nghiêng";
$l['editor_title_underline'] = "Chèn chữ gạch dưới";
$l['editor_title_left'] = "Canh lề trái";
$l['editor_title_center'] = "Canh giữa";
$l['editor_title_right'] = "Canh lề phải";
$l['editor_title_justify'] = "Dàn đều";
$l['editor_title_numlist'] = "Chèn danh sách dạng số";
$l['editor_title_bulletlist'] = "Chèn danh sách dạng dấu chấm";
...
$l['editor_title_code'] = "Chèn mã";
$l['editor_title_php'] = "Chèn mã PHP";
$l['editor_title_close_tags'] = "Đóng tất cả các Mycode đang mở";
$l['editor_enter_list_item'] = "Nhập vào danh sách cần nhập. Bấm cancel hoặc bỏ trống để kết thúc danh sách.";
...
$l['editor_font'] = "Font";
$l['editor_size'] = "Kích cỡ chữ";
$l['editor_color'] = "Màu chữ";

$l['quote'] = "Trích dẫn:";
$l['wrote'] = "Đã viết:";
$l['code'] = "Mã:";
$l['php_code'] = "Mã PHP:";
$l['posted_image'] = "[Hình: {1}]";
$l['linkback'] = "Bài gửi gốc";
...
$l['postbit_attachments'] = "Tập đính kèm";
$l['postbit_attachment_size'] = "Kích cỡ:";
$l['postbit_attachment_downloads'] = "Tải về:";
$l['postbit_attachments_images'] = "Hình ảnh";
$l['postbit_attachments_thumbnails'] = "Hình thu nhỏ";
$l['postbit_unapproved_attachments'] = "{1} tệp đính kèm không duyệt.";
...
$l['postbit_qdelete'] = "Xóa bài viết này";
$l['postbit_profile'] = "Xem thông tin của thành viên này";
$l['postbit_pm'] = "Gửi tin nhắn riêng cho thành viên này";
...
$l['forumjump_usercp'] = "Bảng điều khiển dành cho người dùng";
$l['forumjump_wol'] = "Ai đang online";
$l['forumjump_search'] = "Tìm kiếm";
$l['forumjump_home'] = "Trang nhà";

$l['redirect'] = "Bạn đang được chuyển";
$l['unknown_error'] = "Có lỗi đã xảy ra.";

$l['smilieinsert'] = "Mặt cười";
$l['smilieinsert_getmore'] = "thêm";
$l['on'] = "Mở";
$l['off'] = "Tắt";
$l['unread_report'] = "Ban quản trị chú ý: Có 1 bài báo cáo chưa đọc.";
$l['unread_reports'] = "Ban quản trị chú ý: Có {1} bài báo cáo chưa đọc.";
$l['pending_joinrequest'] = "Chủ nhóm chú ý: Bạn có 1 yêu cầu xin tham gia nhóm đang chờ đợi.";
$l['pending_joinrequests'] = "Chủ nhóm chú ý: Bạn có {1} yêu cầu xin tham gia nhóm đang chờ đợi.";
...
$l['attach_quota'] = "Hiện tại bạn đã sử dụng <strong>{1}</strong> trong số lượng tệp đính kèm được phân bổ của bạn ({2})";
...
$l['deleteevent_confirm'] = "Bạn có chắc là bạn muốn xóa sự kiện này?";
$l['removeattach_confirm'] = "Bạn có chắc là bạn muốn xóa các tệp đính kèm từ bài post này?";

$l['latest_threads'] = "Chủ đề cuối";
...
$l['missing_task'] = "Lỗi: Tập tin nhiệm vụ không tồn tại";
...
$l['task_logcleanup_ran'] = "Nhiệm vụ dọn dẹp nhật ký đã chạy thành công, và đã xóa các log cũ.";
$l['task_promotions_ran'] = "Nhiệm vụ thăng chức đã chạy thành công.";
$l['task_threadviews_ran'] = "Nhiệm vụ lượt xem bài viết đã chạy thành công.";
$l['task_usercleanup_ran'] = "Nhiệm vụ dọn dẹp số thành viên đã chạy thành công.";
$l['task_massmail_ran'] = "Nhiệm vụ chạy thư điện tử số lượng lớn đã thành công.";
$l['task_userpruning_ran'] = "Nhiệm vụ xóa (prune) user đã chạy thành công.";
$l['task_delayedmoderation_ran'] = "Nhiệm vụ trì hoãn kiểm duyệt đã chạy thành công.";
$l['task_massmail_ran_errors'] = "Một hoặc nhiều lỗi đã xảy ra nhắn tới \"{1}\":
{2}";
