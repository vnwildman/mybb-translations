...
$l['memberlist_disabled'] = "Chức năng danh sách thành viên đã bị vô hiệu hóa bởi người quản trị.";

$l['member_list'] = "Danh sách thành viên";
$l['avatar'] = "Ảnh";
$l['username'] = "Tên thành viên";
$l['joined'] = "Ngày gia nhập";
$l['lastvisit'] = "Lần vào cuối";
$l['posts'] = "Số bài viết";
$l['referrals'] = "Giới thiệu";
$l['search_members'] = "Tìm thành viên";
$l['website'] = "Website";
$l['sort_by'] = "Xếp theo";
...
$l['error_no_members'] = "<p>Không tìm thấy thành viên nào với từ khóa bạn đã nhập</p><p>Xin hãy điền vào từ khóa khác và thử lại.</p>";
